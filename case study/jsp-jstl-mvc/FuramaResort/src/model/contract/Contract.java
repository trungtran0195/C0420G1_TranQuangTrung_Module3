...
public class Contract {
    ...
    public Contract(int id, Date contract_start_date, Date contract_end_date, Double contract_deposit, Double contract_total_money, int employee_id, int customer_id, int service_id) {
        this.id = id;
